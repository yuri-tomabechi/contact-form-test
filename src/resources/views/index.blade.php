        ...
        <div class="form__group">
          ...
          <div class="form__group-content">
            <div class="form__input--text tel-inputs">
              <input type="tel" name="tel" maxlength="4" placeholder="080" /> - 
              <input type="tel" name="tel" maxlength="4" placeholder="1234" /> - 
              <input type="tel" name="tel" maxlength="4" placeholder="5678" />
            </div>
            <div class="form__error">
              <!--バリデーション機能を実装したら記述します。-->
            </div>
